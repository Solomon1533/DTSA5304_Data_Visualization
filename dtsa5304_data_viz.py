# -*- coding: utf-8 -*-
"""DTSA5304_Data_Viz.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vOZQlSCWf9bj8IJWkd_oIFd-xFvIC_xQ
"""
...
#fig3.write_image("pie_chart.png" ) # This should work now after installing kaleido
fig3.show()
...
#ax = sns.barplot(x=x, y=y, hue=y, legend=False)
g = sns.boxplot(data=data_Catagories,
                x='Subscriber',
                y='Catagories',
                order=median_order,
                hue = 'Catagories', #Corrected the typo here from 'Categories' to 'Catagories'
